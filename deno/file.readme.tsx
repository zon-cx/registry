  ...
  try {
    ...
    return c.render(
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="readme-indicator bg-gray-100 text-gray-800 px-2 py-1 rounded-full text-xs font-medium">README</span>
                    </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <iconify-icon icon="lucide:eye" className="h-4 w-4 mr-2"></iconify-icon>
                  Preview
                </button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden border-l-4 border-gray-500">
            <div className="bg-gray-50 px-4 py-2 border-b border-gray-200">
              <div className="flex items-center space-x-2">
                <iconify-icon icon="lucide:file-text" className="h-4 w-4 text-gray-600"></iconify-icon>
